                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" action="{{ route('password.store') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <x-text-input id="password" class="" type="password" name="password" required autofocus />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <x-text-input id="password_confirmation" class="" type="password" name="password_confirmation"  required autofocus />
