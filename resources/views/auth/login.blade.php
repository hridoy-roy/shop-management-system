                                    ...
                                    <div class="mt-4">
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <x-text-input id="username" type="email" name="email" placeholder="Enter Email" :value="old('email', 'admin@themesbrand.com')" required autofocus />
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup @error('password') is-invalid @enderror">
                                                    <x-text-input id="password" type="password" name="password" placeholder="Enter Email" :value="old('password', '123456')" required autofocus placeholder="Enter password" />
